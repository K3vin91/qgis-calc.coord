...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'calccoords_dialog_base.ui'))


class CalcCoordsDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(CalcCoordsDialog, self).__init__(parent)
        ...
        #Conectores UTM a Lat/Lon
        self.spbX.valueChanged.connect(self.to_LatLon)
        self.spbY.valueChanged.connect(self.to_LatLon)
        self.zone.valueChanged.connect(self.to_LatLon)
        self.banda.currentTextChanged.connect(self.to_LatLon)

        #conectores Lat/Lon a UTM
    ...
    def to_LatLon(self):
        ...
        easting = self.spbX.value()
        northing = self.spbY.value()
        zone_number = self.zone.value()
        zone_letter = self.banda.currentText()
        ...
        self.spbLonDD.setValue(lonDegrees)
        self.spbLatDD.setValue(latDegrees)
    ...
    def to_UTM(self):
        ...
        self.spbX.setValue(X)
        self.spbY.setValue(Y)
        self.zone.setValue(huso)
        self.mercen.setValue(cenMer)
        self.banda.setCurrentText(zona)
